      ...
      <CardContent className="py-6">
        <div className="flex flex-wrap items-start justify-between gap-3 mb-6">
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Август, новые и переходящие заявки — от создания до первого ответа
            </p>
          </div>
        ...
        <div className="flex items-start gap-2.5 mt-5 p-3 rounded-lg bg-muted/50">
          ...
          <p className="text-xs leading-relaxed">
            ...
            Заявка попадает в август по дате ответа, поэтому сюда входят и вопросы,
            заданные раньше{data.carried ? ` (таких ${data.carried})` : ''}. Оранжевым
            отмечены те, кто отвечает медленнее среднего по отделу. Наведите на полосу —
            покажет медиану и число заявок.
          </p>
        </div>
      </CardContent>
    </Card>
