...
CASE
  ...
  WHEN x ~ 'vpn|впн|удаленк|удал.нн|уд\\.стол|уд\\.? ?раб|рабоч.. стол|anydesk|анидеск|энидеск|интернет|wi-?fi|вай.?фай|сетев.* папк|серв[ае]р|терминал|хостинг|виртуалк' THEN 'Серверы и инфраструктура'
